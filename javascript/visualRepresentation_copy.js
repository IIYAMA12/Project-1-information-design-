...
function makeSecondaryChart (fileData, allData) {
    ...
    if (secondaryGraphData != undefined) {
        ...
        var colorRangeG = d3.scaleLinear().domain([i, allData.length]).range([firstColor.g, secondColor.g]);
        var colorRangeB = d3.scaleLinear().domain([i, allData.length]).range([firstColor.b, secondColor.b]);
